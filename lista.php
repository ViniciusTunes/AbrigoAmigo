    ...
    <body>
        ...
        <header class="header" id="header">
            <nav class="nav container">
                ...
                <div class="umBtn">
                <a href="doacao.html" class="button button__header">Voltar</a>
                </div>
            </nav>
        </header>
...
<center>
         <h2>Doações de Alimentos Pendentes e Realizadas</h2>
         <br>
        
<?php
        $sql = "SELECT * FROM Doacao ORDER BY ID";
...
$cadastrados = 1;
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        echo "<td>$row[ID]</td>";
        echo "<td>$row[cpf]</td>";
        echo "<td>$row[arroz]</td>";
        echo "<td>$row[feijao]</td>";
        echo "<td>$row[macarrao]</td>";
        echo "<td>$row[acucar]</td>";
        echo "<td>$row[sal]</td>";
        echo "<td>$row[farinha]</td>";
        echo "<td>$row[oleo]</td>";
        echo "<td>$row[enlatados]</td>";
        echo "<td>$row[data]</td>";
        echo "</tr>";
        $cadastrados++;
