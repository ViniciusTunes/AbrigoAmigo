...
<center>
         <h2>Doações de Produtos de Limpeza Pendentes e Realizados</h2>
         <br>
        
<?php
        $sql = "SELECT * FROM ProdutosLimpeza ORDER BY ID";
  ...
  echo "<thead>";
            ...
            echo"<th>DETERGENTE</th>";
            echo"<th>SABÃO</th>";
            echo"<th>ÁLCOOL</th>";
            echo"<th>ESCOVA DENTE</th>";
            echo"<th>PASTA</th>";
            echo"<th>DATA</th>";
...
$cadastrados = 1;
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        echo "<td>$row[ID]</td>";
        echo "<td>$row[cpf]</td>";
        echo "<td>$row[detergente]</td>";
        echo "<td>$row[sabao]</td>";
        echo "<td>$row[alcool]</td>";
        echo "<td>$row[escovad]</td>";
